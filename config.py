...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002296264776"))
JOIN_REQUEST_ENABLE = os.environ.get("JOIN_REQUEST_ENABLED", "-1002888391802")
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "7686808821").split()):
        ADMINS.append(int(x))
except ValueError:
